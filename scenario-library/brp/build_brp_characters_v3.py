...
# ═══════════════════════════════════════════════════════════════════════════════
# CHARACTER DATA  —  with 'weapons' added to every character
# Weapon fields: name, skill, atk, par, damage, notes
# ═══════════════════════════════════════════════════════════════════════════════
...
NC_CHARS = [
  {'name':'Sable Kress','arch':'The Fixer','meta':'Neo-Ashford Operative','allg':'Veltris Contract — Active',
   ...
   'weapons':[
     {'name':'Licensed Pistol',  'skill':'Firearms (Pistol)','atk':'40%','par':'—',  'damage':'2D6',   'notes':'Rng 30m · 15 rds · Mal 00'},
     {'name':'Tactical Knife',   'skill':'Knife (base)',     'atk':'25%','par':'20%','damage':'1D4+2', 'notes':'Boot knife · base chance only'},
   ],
   'sp_name':'"Subdermal Comms Mesh"','sp_type':'Corporate neural comm implant — jaw subdermal, Veltris issue',
   'sp_stats':'Encrypted 500m range  ·  Signal sense 10m  ·  Emergency wipe (1-use)',
  ...
  {'name':'Juno Rhee','arch':'The Ghost','meta':'Sub-District 7 background','allg':'Veltris Contract — Active',
   ...
   'weapons':[
     {'name':'Compact Holdout',  'skill':'Firearms (Pistol)','atk':'40%','par':'—',  'damage':'1D8',   'notes':'Rng 20m · 8 rds · Mal 00'},
     {'name':'Monoblade',        'skill':'Melee',            'atk':'45%','par':'45%','damage':'1D8+2', 'notes':'Ceramic · no scanner · can impale'},
   ],
   'sp_name':'"ECM Shroud Suite"','sp_type':'Active countermeasure implant — collarbone/shoulder subdermal, black-market military-clone',
   'sp_stats':'Drone ID blackout 5m  ·  +20% Stealth active  ·  Signal intercept passive',
  ...
  {'name':'Viktor Drav','arch':'The Muscle','meta':'Ex-Meridian Security Group','allg':'Veltris Contract — Active',
   ...
   'weapons':[
     {'name':'Military Sidearm',  'skill':'Firearms (Pistol)','atk':'65%','par':'—',  'damage':'2D6+2',  'notes':'Rng 40m · 15 rds · Mal 00'},
     {'name':'Combat Baton',      'skill':'Melee',            'atk':'55%','par':'55%','damage':'1D8+DB', 'notes':'Telescopic · DB: +1D4 · can parry'},
     {'name':'Brawl/Grapple',     'skill':'Brawl',            'atk':'60%','par':'60%','damage':'1D3+DB', 'notes':'Unarmed · DB: +1D4 · grab/throw option'},
   ],
   'sp_name':'"Subdermal Combat Plates + Reflex Tap"','sp_type':'Meridian Security Group standard issue — shoulder/torso armour + spinal reflex tap',
   'sp_stats':'+2 armour (torso/shoulders)  ·  +1 DEX on combat SR  ·  Involuntary counter-attack',
  ...
  {'name':'Tal Morgan','arch':'The Tech','meta':'Neo-Ashford Freelance','allg':'Veltris Contract — Active',
   ...
   'weapons':[
     {'name':'Compact Sidearm',  'skill':'Firearms (Pistol)','atk':'30%','par':'—',  'damage':'1D8',    'notes':'Rng 20m · 8 rds · Mal 00'},
     {'name':'Multi-Tool Blade', 'skill':'Knife (base)',     'atk':'25%','par':'20%','damage':'1D4+1',  'notes':'From tool roll · base chance'},
     {'name':'EMP Pulse Device', 'skill':'Electronics',      'atk':'—',  'par':'—',  'damage':'Special','notes':'1-use · 10m radius · all electronics fail incl. augments'},
   ],
   'sp_name':'"Neural I/O Bridge"','sp_type':'Direct machine interface — behind-ear subdermal, self-built prototype, 11 months',
   'sp_stats':'Direct interface +15% Electronics  ·  Drone sync (visual cortex)  ·  Passive net sense 20m',
   'sp_abilities':[('Direct interface','Touch-range interface with any electronic system. Electronics +15% when using direct contact.'),('Drone sync','Drone feeds directly to visual cortex. -10% Spot Hidden in vicinity while synced.'),('Passive network sense','Within 20m: detects active wireless transmissions and direction. No roll.'),('Cost','Self-installed. Neural integration 73% stable. Once per session: 2-3 sec feedback spike, no action possible. Has never told anyone it was self-installed.')],
  ...
  {'name':'Reina Vasquez','arch':'The Medic','meta':'Neo-Ashford Contract Medic','allg':'Veltris Contract — Active',
   ...
   'weapons':[
     {'name':'Compact Pistol',     'skill':'Firearms (Pistol)','atk':'30%','par':'—',  'damage':'1D10',   'notes':'Rng 25m · 10 rds · Mal 00'},
     {'name':'Brawl',              'skill':'Brawl',            'atk':'30%','par':'30%','damage':'1D3',    'notes':'Unarmed · no DB'},
     {'name':'Sedative Injector',  'skill':'Medicine',         'atk':'30%','par':'—',  'damage':'Special','notes':'Med roll to hit skin · CON resist or unconscious 1D4hr · 2 doses'},
   ],
   'sp_name':'"Biometric Diagnostics Array"','sp_type':'Medical diagnostic augment — palm/fingertip subdermal sensors, Meridian Medical licensed',
   'sp_stats':'Tactile diagnosis  ·  Toxin detection  ·  Bio-scanner sync to 8m',
   'sp_abilities':[('Tactile diagnosis','Touch skin: temp, pulse, BP readout. Medicine +20% when treating someone she has touched.'),('Toxin detection','Identifies presence and class of toxin/pathogen at contact range.'),('Bio-scanner sync','Wrist-strap range extends to 8m with structural anomaly detection. Near the entity: behaves strangely.'),('Cost','The array reads everything. A person lying shows different biometrics. Reina has learned to stop looking when she doesn\'t want to know.')],
   ...
   'hook':'A colleague described unusual organic tissue in thoracic cavities: growing inward, entry point unknown. Colleague reassigned. Tonight Reina finds the entry point.',
  ...
  {'name':'Petra Amis','arch':'The Analyst','meta':'Independent Research Contractor','allg':'Veltris Contract — Active',
   ...
   'weapons':[
     {'name':'Micro Pistol',     'skill':'Handgun (base)',    'atk':'20%','par':'—',  'damage':'1D6',    'notes':'Rng 15m · 6 rds · Mal 00 · untrained'},
     {'name':'Signal Scanner',   'skill':'Improvised (base)','atk':'20%','par':'—',  'damage':'1D4',    'notes':'Used as club · base chance · one use before damaged'},
   ],
   'sp_name':'"Encrypted Cortex Store"','sp_type':'Memory and data augment — temple subdermal, unknown manufacturer, received as payment 2yrs ago',
   'sp_stats':'Eidetic recall  ·  Encrypted memory partition  ·  Passive cross-indexing',
   'sp_abilities':[('Eidetic recall','Any text or data directly observed recalled exactly. Research +20% from recalled material.'),('Encrypted partition','Locked cortex section. 12-char passphrase only Petra knows. ~40hrs high-fidelity data.'),('Passive indexing','Unconsciously cross-references all new information. Once per session: GM may tell Petra one thing the table missed.'),('Cost','Manufacturer unknown. Provided as payment in kind. Locked partition: something put there 18 months ago, never opened since.')],
   'sp_note':'The passphrase is the name of the client who paid her with this augment. She has never said that name aloud.',
...
D1_CHARS = [
  {'name':'Kira Osei-Mensah','arch':'NHS Junior Doctor (off duty)','meta':'South Bank, Sunday 17 May','allg':'Reach: Abena (mother, 74, Peckham)',
   ...
   'weapons':[
     {'name':'Scalpel/Blade',  'skill':'Knife (base)', 'atk':'25%','par':'—',  'damage':'1D4',   'notes':'From medical kit · base chance · can impale'},
     {'name':'Brawl',          'skill':'Brawl',        'atk':'25%','par':'25%','damage':'1D3',   'notes':'Unarmed · no DB'},
   ],
   'sp_name':'What You Know That Others Don\'t','sp_type':'22 hours post-night-shift. Triage training. Hospital ID.',
   'sp_stats':'First Aid 75%  ·  Medicine 55%  ·  Triage (no roll)  ·  NHS ID access',
   'sp_abilities':[('Triage (no roll)','Once per scene: assess all wounded in view, rank by survivability in one round.'),('Improvised medicine','First Aid 75% becomes 55% with improvised supplies.'),('Infection assessment','Medicine 50%: assess bite victim\'s timeline. The answer will not be comforting.'),('Running on fumes','22hrs awake: -10% all non-medical rolls after Act Two begins.')],
  ...
  {'name':'Dev Krishnamurthy','arch':'Freelance software engineer','meta':'Borough Market café, Sunday','allg':'Reach: flatmate near Old Street',
   ...
   'equipment':['MacBook Pro — 81% battery, tracking spread on four social media threads','Phone — 94% battery, scanner app notifications since 9:40 AM','Laptop bag: charger, USB hub, notebook (unused), protein bar','AirPods (full charge)','Wallet: £45 cash, three cards, Oyster (£8.40)','Voice note from flatmate about spare keys — unanswered, one hour old'],
   'weapons':[
     {'name':'Laptop (improvised)','skill':'Improvised (base)','atk':'20%','par':'—', 'damage':'1D4',   'notes':'Heavy, slow · base chance · one use before damaged'},
     {'name':'Brawl',             'skill':'Brawl (base)',     'atk':'25%','par':'25%','damage':'1D3',   'notes':'Unarmed · no DB · untrained'},
   ],
   'sp_name':'What You Know That Others Don\'t','sp_type':'Emergency scanner app. Tracking spread since 9:40 AM — 67 minutes before the alert.',
   'sp_stats':'Computer Use 75%  ·  Early spread data  ·  Network access  ·  Signal mapping',
   'sp_abilities':[('Early data','Knows Elephant & Castle origin, three smoke plume locations, spread rate. Group should ask him.'),('Network access','While signal exists: open CCTV, transport data, social media.'),('Signal mapping','Map cell tower activity to find crowd concentrations. 20-min task.'),('Cost — what he hasn\'t said','Has been watching since 9:40 AM. Told no one. Filed it as monitoring.')],
  ...
  {'name':'Maggie Donnelly','arch':'Retired Metropolitan Police (22 yrs)','meta':'Jubilee Walkway, Sunday','allg':'Reach: Cara (daughter, Deptford)',
   ...
   'sp_name':'What You Know That Others Don\'t','sp_type':'First on scene, Tavistock Square 2005. 22 years crowd management.',
   'sp_stats':'Persuade +20% evacuation  ·  Scene assessment (no roll)  ·  Warrant card (1-use, 60%)',
  ...
  {'name':'Olu Adeyemi','arch':'Security guard, The Shard','meta':'Shard lobby, Sunday overtime','allg':'Reach: No family in London — group becomes the motivation',
   ...
   'sp_name':'What You Know That Others Don\'t','sp_type':'The Shard: CCTV, radio, roof sightlines, full building access.',
   'sp_stats':'Full building access  ·  Radio fragments  ·  CCTV 200m  ·  Shard sightlines',
  ...
  {'name':'Priya Mehta','arch':'Science journalist','meta':'Southbank Centre, Sunday','allg':'Reach: editor (has Meridian documents)',
   ...
   'weapons':[
     {'name':'Brawl',            'skill':'Brawl (base)',    'atk':'20%','par':'20%','damage':'1D3',   'notes':'Unarmed · no DB · last resort'},
     {'name':'Pen/Improvised',   'skill':'Improvised (base)','atk':'20%','par':'—', 'damage':'1D3',   'notes':'Stab or club · base chance · very last resort'},
   ],
   'sp_name':'What You Know That Others Don\'t','sp_type':'Editor has Meridian Biosciences documents. They arrived 48hrs before the outbreak.',
   'sp_stats':'Research 70%  ·  Meridian thread  ·  Source assessment  ·  Press access (1-use)',
   'sp_abilities':[('Meridian thread','Editor has Meridian Biosciences documents. Research 70%/Psychology 55%: piece together the Meridian-to-outbreak connection.'),('Source assessment','Evaluate credibility of any info source: Insight 65%.'),('Story vs group','Best positioned to understand the truth. Using it to help vs document is a genuine player choice.'),('Press access (1-use)','Valid lanyard. In the first two hours, officials sometimes still respond. Once per session.')],
  ...
  {'name':'Tom Becker','arch':'Scaffolding worker','meta':'Waterloo Road side street, Sunday','allg':'Reach: his van (exit route) and his mum (no answer)',
   ...
   'weapons':[
     {'name':'Crowbar',    'skill':'Melee',  'atk':'50%','par':'45%','damage':'1D8+DB','notes':'From tool bag · DB: +1D4 · can parry · best melee option'},
...
def get_skill(char, name_fragment):
    """Pull a skill % from the skills list by partial name match."""
...
def build_pdf(path, CHARS, t, cover_title, cover_sub, cover_byline, rules, portraits=None):
    ...
    for char in CHARS:
        ...
        wt = Table(wep_rows, colWidths=cw)
        wt.setStyle(TableStyle(ts))
        story.append(wt)

        # Dodge + DB summary strip
        dodge_row = Table([[
...
D1_RULES=[
    ...
    ['SR = DEX + INT', 'Attack: D100 ≤ skill%', 'DB 25-32: +1D4 | 33-40: +1D6'],
    ['Bite: CON resist or symptomatic', 'Zombie: head shot only for instant kill', 'SAN loss on zombie encounter'],
]

build_pdf('/mnt/user-data/outputs/brp-night-crawler-v3.pdf', NC_CHARS, NC,
    "THE NIGHT CRAWLER",
    "Player Character Reference — Neo-Ashford, 2087",
    "Basic Role-Playing  ·  Event 91  ·  ChaosiumCon 2026",
    NC_RULES, portraits=NC_PORTRAITS)

build_pdf('/mnt/user-data/outputs/brp-day-one-v3.pdf', D1_CHARS, D1,
